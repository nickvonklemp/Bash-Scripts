...
sleep 1
pane=${window}.1
tmux send-keys -t "$pane" C-z "./wrk2/wrk -t6 -c$con -d120s -R700000 http://$ip1/1mb.bin" Enter
pane=${window}.2
tmux send-keys -t "$pane" C-z "./wrk2/wrk -t6 -c$con -d120s -R700000 http://$ip2/1mb.bin" Enter
sleep 1
