...
# Assign local variables for PCI address and firmware directory
PCIADDR=$(basename $(readlink -e /sys/class/net/${DEVICE}/device))
FWDIR="/lib/firmware/netronome"
echo "PCI Address: $PCIADDR"
...
echo "Please reload NFP drivers for changes to take effect..."
